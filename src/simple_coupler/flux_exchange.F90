...
!-----------------------------------------------------------------------
character(len=128) :: version = '$Id: flux_exchange.F90,v 1.1.1.1 2011/07/11 21:09:17 miz Exp $'
...
integer :: id_drag_moist,  id_drag_heat,  id_drag_mom,              &
           ...
           id_t_surf, id_t_flux, id_q_flux, id_r_flux, id_slp,      &!miz
...
!--- compute explicit fluxes and tendencies at all available points ---
   ...
   call surface_flux_2d (Atm%t_bot, Atm%tr_bot(:,:,isphum), Atm%u_bot, Atm%v_bot,        &
                      ...
                      Atm%vort850, Atm%rh500, Atm%rh700, Atm%rh850, Atm%swfq)
...
!-------------------- diagnostics section ------------------------------
 ...
 if (first_static) then
   ...
   if ( id_slp         > 0 ) used = send_data ( id_slp,         Atm%slp,      Time ) !miz
